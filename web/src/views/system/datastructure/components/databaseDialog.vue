<template>
  <el-dialog
    ...
    <el-form autoComplete="on" :model="form" :rules="rules" ref="ruleFormRef"
             ...
             label-width="100px">
      <el-form-item label="名称" :required="true" prop="database">
        <el-input v-model="form.database" placeholder="数据结构名称"></el-input>
      </el-form-item>
      <el-form-item label="描述" :required="true" prop="host">
        <el-input v-model="form.host" placeholder="数据结构描述">></el-input>
      </el-form-item>
