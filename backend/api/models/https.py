...
class Api(Model):
    ...
    * directory_id: 目录id
    ...
    headers = TextField(verbose_name=_('Api Headers'), null=False)
    params = TextField(verbose_name=_('Api Params'), null=False)
    data = TextField(verbose_name=_('Api Data'), null=False)
    json = TextField(verbose_name=_('Api Json'), null=False)
    hooks = TextField(verbose_name=_('Api Hooks'), null=False)
    directory_id = CharField(max_length=50, null=True, blank=True, verbose_name=_('Api DirectoryId'))
    validate = TextField(verbose_name=_('Api Validate'), null=False)
    extract = TextField(verbose_name=_('Api Extract'), null=False)
